...
export const AnalyticsCards = memo(function AnalyticsCards({ totalRequests, totalVotes, activeGenres, onAddSongClick }: AnalyticsCardsProps) {
  const cards = [
    {
      icon: Music,
      title: 'Requests',
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      ...
      {/* Add Song Button */}
      <AddSongButton onClick={onAddSongClick} />
    </div>
  );
});
