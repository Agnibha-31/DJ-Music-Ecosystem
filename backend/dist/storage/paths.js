...
export const authPath = (fileName) => path.join(AUTH_ROOT, fileName);
export const collectionPath = (fileName) => path.join(COLLECTIONS_ROOT, fileName);
export const auditPath = (fileName) => path.join(AUDIT_ROOT, fileName);
